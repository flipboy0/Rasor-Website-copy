...
const Events = () => {
  return (
    <div className='flex w-full h-[80vh] bg-[#861D1D]'>
        <div className='flex flex-col w-3/5 h-full pr-[80px] px-[40px] pb-[80px] border-r-2 border-white'>
            <div className='flex justify-between h-1/5 py-10'>
            ...
            <div className='flex gap-10 h-4/5 justify-between'>
