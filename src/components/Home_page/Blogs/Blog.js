...
const Blog = (props) => {
  const backgroundImageUrl = './components/bgyellow.png'; // Replace with your actual image URL
  ...
  return (
    <div className="flex flex-col items-left min-h-screen" style={{ backgroundImage: `url(${backgroundImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'left' }}>
      ...
      <div className="flex flex-col items-center justify-between w-full max-w-screen-xl mx-auto px-8 md:px-16 lg:px-32 py-8 bg-white bg-opacity-80">
