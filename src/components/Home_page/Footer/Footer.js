...
const Footer = (props) => {
  ...
  return (
    <footer className="text-gray-600 body-font border-t-4 border-red-800 " style={{ backgroundImage: `url(${backgroundImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'left', }}>
      <div className="flex justify-center w-full bg-image py-10">
        <div className="w-full flex flex-wrap justify-between md:text-left text-center order-first">
  
            <div className="w-full mx-[160px] bg-black/60 hover:bg-black/80 ring-2 ring-red-800 m-auto flex flex-wrap md:text-left text-center order-first py-5">
            {/* Logo and name */}
            <div className='flex flex-col lg:w-[24%] pr-10'>
              <div className="flex title-font font-medium items-center justify-center text-white">
                <img src={logo} alt="RaSoR Logo" className="w-[100px] h-[100px] rounded-full" />
              </div>
              <div className='flex justify-center mt-3'>
                <span className="ml-3 text-white text-center text-xl">Ramanujan Society of Research</span>
              </div>
            </div>
            {/* About Us Section */}
            <div className="lg:w-[19%] px-4 pl-5">
              <h2 className="title-font font-semibold text-red-400 tracking-widest text-md mb-3">About Us</h2>
              <nav className="list-none mb-5 text-white border-length border-r-2 border-red-800 pr-2 lg:pr-0">
                <li>
      ...
      <div className="bg-black/90 border-t-2 border-red-800">
        <div className="flex flex-col-reverse justify-center items-center">
          ...
          <span className="flex py-3 justify-center ">
